...
final eventAttachmentsProvider =
    StreamProvider.family<List<Attachment>, int>((ref, eventId) {
...
final todoAttachmentsProvider =
    StreamProvider.family<List<Attachment>, int>((ref, todoId) {
  final db = ref.watch(databaseProvider);
  return (db.select(db.attachments)
        ..where((t) =>
...
final createAttachmentProvider =
  ...
  return ({
    ...
    return db.into(db.attachments).insert(AttachmentsCompanion.insert(
